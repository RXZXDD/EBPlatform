...
namespace EBPlatform.Controllers
{
    public class ProductsController : Controller
    {
        ...
        {
            return View("AdminProduct", await _context.Product.ToListAsync());
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,PName,PDescribe,PPrice,PNum")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
        ...
        //Actions For Clients
        public async Task<IActionResult> ClientProduct()
        {
            return View("ClientProduct", await _context.Product.ToListAsync());
        }
        ...
        public async Task<IActionResult> BuyProduct(int? id)
        {
            ...
            return View("BuyConfirm", product);
        }
    }
}
